...
public class MessageParser {
    ...
    public MessageModel parseMessage(JsonObject msg) {
        ...
        long fileId = extractFileId(content, contentType);
        String localFilePath = extractLocalPath(content, contentType);
    ...
    private long extractFileId(JsonObject content, String type) {
    ...
    private String extractLocalPath(JsonObject content, String type) {
