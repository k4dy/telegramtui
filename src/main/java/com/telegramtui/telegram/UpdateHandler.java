...
public class UpdateHandler {
	private volatile String connLabel = "Connecting...";
	...
	public void onUpdate(String json) {
		...
		if ("updateAuthorizationState".equals(type)) {
			String authType = TelegramClient.getNestedType(json, "authorization_state");
			if ("authorizationStateWaitPassword".equals(authType)) {
				String hint = TelegramClient.getString(json, "password_hint");
				String emailPattern = TelegramClient.getString(json, "recovery_email_address_pattern");
			...
			String connType = TelegramClient.getNestedType(json, "state");
